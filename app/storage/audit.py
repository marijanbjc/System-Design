...
class AuditStore:
    ...
    Соединение одно на экземпляр и защищено локом: FastAPI обслуживает синхронные
    обработчики в пуле потоков, а sqlite3 не разрешает делить соединение между
    потоками без явного разрешения.
    """
